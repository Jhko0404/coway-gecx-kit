...
def list_invoices() -> dict:
    """List the rental invoices available for the authenticated customer (newest first).

    Returns:
        dict: list result or error details.
    """
    ...
    return {"status": "success", "currency": CURRENCY,
            "invoices": summarize_bills(summaries, lang),
            "agent_action": ("Tell the customer which invoices you can discuss; "
                             "ask which they'd like.")}
